...
class Printer3D(machine.Machine):
    ...
    def __init__(self):
        ...
        self.getSettingByKey('support_angle').setCopyFromParentFunction(None)
        self.getSettingByKey('support_fill_rate').setCopyFromParentFunction(None)
        self.getSettingByKey('support_xy_distance').setCopyFromParentFunction(None)
        self.getSettingByKey('support_z_distance').setCopyFromParentFunction(None)
